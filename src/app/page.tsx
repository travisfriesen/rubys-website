  ...
  return (
    <main>
      <div>
          ...
          <div className="grid grid-cols-2 gap-x-16 gap-y-8 mr-[16vw] ml-[16vw] mb-16 mt-8">
              <Card title="Golf" desc="Come on down to our Driving Range, where you can perfect your swing against a backdrop of up to 280 yards of range. Whether you're a seasoned golfer or a beginner looking to improve, our range offers bundles of 52 balls for $12 or 104 balls for $22. Don't worry about bringing your clubs – we provide club rentals at $5 per club or $20 for a complete set with a valid driver's license. Located in Winnipeg Beach, Manitoba, our driving range is the ideal spot to practice your game and enjoy the fresh air." link="/golf"></Card>
              <Card title="Mini Golf" desc="Exciting news! Mini golf is coming soon to Winnipeg Beach at Boardwalk Station, adding a fun and scenic activity to your lakeside adventures. Get ready to putt your way through our engaging course, perfect for family outings, date nights, or friendly competitions with friends. Stay tuned for updates on our grand opening, where you can enjoy a round of mini golf amidst the beautiful boardwalk surroundings." link="/minigolf"></Card>
              ...
              <Card title="Hotdog Cart" desc="Join us at the Winnipeg Beach Farmers Market every Friday through Sunday for a savory treat at our hotdog cart! We proudly serve up a variety of options including classic hotdogs, flavorful smokies, juicy chicken burgers, and delicious plant-based burgers. Enjoy your favorite fare in the vibrant atmosphere of the market—it's the perfect weekend treat at Winnipeg Beach!" link="/hotdog"></Card>
          </div>
      </div>
    </main>
  );
